...
/** @hide */
	...
	static {
		__md_methods = 
			"n_requestView:(Landroid/content/Context;I)Landroid/view/View;:GetRequestView_Landroid_content_Context_IHandler:DevExpress.XamarinAndroid.Grid.IViewProviderInvoker, DevExpress.Maui.Android.Grid\n" +
			"n_storeAsFree:(Landroid/view/View;)V:GetStoreAsFree_Landroid_view_View_Handler:DevExpress.XamarinAndroid.Grid.IViewProviderInvoker, DevExpress.Maui.Android.Grid\n" +
			"n_updateAppearance:(Landroid/view/View;Lcom/devexpress/dxgrid/models/columns/GridColumnModel;Lcom/devexpress/dxgrid/models/appearance/AppearanceBase;I)V:GetUpdateAppearance_Landroid_view_View_Lcom_devexpress_dxgrid_models_columns_GridColumnModel_Lcom_devexpress_dxgrid_models_appearance_AppearanceBase_IHandler:DevExpress.XamarinAndroid.Grid.IViewProviderInvoker, DevExpress.Maui.Android.Grid\n" +
			"n_updateContent:(Landroid/view/View;Lcom/devexpress/dxgrid/providers/DataProvider;Ljava/lang/String;I)V:GetUpdateContent_Landroid_view_View_Lcom_devexpress_dxgrid_providers_DataProvider_Ljava_lang_String_IHandler:DevExpress.XamarinAndroid.Grid.IViewProviderInvoker, DevExpress.Maui.Android.Grid\n" +
			"";
